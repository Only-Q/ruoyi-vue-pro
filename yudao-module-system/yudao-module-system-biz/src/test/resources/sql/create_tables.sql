...
CREATE TABLE IF NOT EXISTS "system_biology_sample" (
   "id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY,
   "checkup_no" varchar NOT NULL,
   "name" varchar NOT NULL,
   "sex" varchar NOT NULL,
   "x_no" varchar NOT NULL,
   "blood_no" varchar,
   "biochemistry_no" varchar,
   "urine_no" varchar,
   "serum_location" varchar,
   "plasma_location" varchar,
   "blood_cells_location" varchar,
   "urine_location" varchar,
   "checkup_time" datetime NOT NULL,
